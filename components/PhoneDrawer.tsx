  ...
  return (
    <Drawer open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
      <DrawerTrigger asChild>
        <Button
          variant="ghost"
          className="p-5 rounded-full border-2 border-black bg-white hover:bg-gray-100 transition-all duration-200 shadow-sm hover:shadow-md"
                    ...
                    {translatedInfo?.branch1.phone && (
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <a 
                            href={`tel:${translatedInfo.branch1.phone.replace(/[^0-9]/g, '')}`}
                    ...
                    {translatedInfo?.branch1.phone2 && (
                      <div className="flex items-center gap-3 ml-2">
                        ...
                        <div className="flex-1">
                          ...
                          <a 
                            href={`tel:${translatedInfo.branch1.phone2.replace(/[^0-9]/g, '')}`}
                      ...
                      {translatedInfo?.branch2.phone && (
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            <p className="text-sm text-gray-600">{t('phone')}</p>
                            <a 
                              href={`tel:${translatedInfo.branch2.phone.replace(/[^0-9]/g, '')}`}
                              className="text-base font-semibold text-gray-800 hover:text-green-600 transition-colors"
                            >
                      ...
                      {translatedInfo?.branch2.phone2 && (
                        <div className="flex items-center gap-3 ml-2">
                          ...
                          <div className="flex-1">
                            <p className="text-sm text-gray-600">{t('phone2')}</p>
                            <a 
                              href={`tel:${translatedInfo.branch2.phone2.replace(/[^0-9]/g, '')}`}
                              className="text-base font-semibold text-gray-800 hover:text-blue-600 transition-colors"
                            >
